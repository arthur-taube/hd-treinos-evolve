-- Create function to get available exercises (official + custom) for a muscle group
...
-- Create function to replace exercise in future instances
...
-- Create function to apply temporary substitution
